        ...
        <div className="">
            ...
            <div className="rest-div grid gap-4 mt-8 ">
              <div className="glass px-8 py-2 rounded-2xl h-36 mb-4 border-2 border-cyan-800 text-white">
                ...
                <div className="know-body  text-justify">
                  ...
                  backend solutions with Django, Flutter, and MERN. Includes
                  three successful live projects.
                </div>
              </div>
              <div className="glass px-8 py-2 rounded-2xl h-36 mb-4 border-2 border-cyan-800 text-white">
          ...
          <div className="flex place-content-center gap-4 mt-16 mb-12 text-white">
            <div className="div-left-about">
              <div className="flex place-content-center mb-6 text-2xl font-semibold">
                Courses
              </div>
              <div className="flex place-content-center">
                <div className="">
                  {" "}
                  <div className="edu-detail-div-glass mb-8 rounded-t-2xl py-3 px-6">
                    <div className="edu-detail-div-glass-head text-xl font-semibold mb-1">
                      Web Development Bootcamp
                    </div>
                    <div className="edu-detail-div-glass-body text-xl mb-4">
                      From Udemy
                    </div>
                    <div className="flex place-content-center">
                      <button className="edu-detail-div-glass-time text-lg font-semibold px-4 py-1 rounded-lg">
                        02 Months
                      </button>
                    </div>
                  </div>
            ...
            <div className="div-right-about">
              ...
              <div className="flex place-content-center">
                <div className="">
                  ...
                  <div className="edu-detail-div-glass mb-8 py-3 px-6">
                    <div className="edu-detail-div-glass-head text-xl font-semibold mb-1">
                      Bachelor's of Arts (History hons.)
                    </div>
                    <div className="edu-detail-div-glass-body text-xl mb-4">
                      From Anugrah Narayan College, Patna
                    </div>
                    <div className="flex place-content-center">
                      <button className="edu-detail-div-glass-time text-lg font-semibold px-4 py-1 rounded-lg">
                        03 Years
                  ...
                  <div className="edu-detail-div-glass mb-8 rounded-b-2xl py-3 px-6">
                    ...
                    <div className="edu-detail-div-glass-body text-xl mb-4">
                      From Xavier's English School, Konnagar, WB
                    </div>
                    <div className="flex place-content-center">
                      <button className="edu-detail-div-glass-time text-lg font-semibold px-4 py-1 rounded-lg">
                        02 Years
